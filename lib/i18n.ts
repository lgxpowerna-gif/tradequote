...
export const i18n = {
  en: {
    ...
    download: "Download PDF", convert: "Convert to Invoice", limitHit: "Free limit reached",
    limitText: "You've used your free documents this month. Upgrade for unlimited quotes & invoices.",
    ...
    featurePro: ["Unlimited documents", "No watermark", "All templates", "Deposit tracking", "Priority support"],
    startMo: "Start $9/mo", startYr: "Best value $79/yr",
  ...
  fr: {
    ...
    download: "Télécharger PDF", convert: "Convertir en facture", limitHit: "Limite gratuite atteinte",
    limitText: "Vous avez utilisé vos documents gratuits ce mois-ci. Passez à Pro pour l'illimité.",
    ...
    featurePro: ["Documents illimités", "Sans filigrane", "Tous les templates", "Suivi acomptes", "Support prioritaire"],
    startMo: "Démarrer 9 $/mois", startYr: "Meilleure offre 79 $/an",
